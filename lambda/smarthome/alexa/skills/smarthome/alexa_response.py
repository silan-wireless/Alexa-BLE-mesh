...
class AlexaResponse:
    ...
    def __init__(self, **kwargs):
        ...
        self.event = {
            ...
            'endpoint': {
                ...
                "endpointId": kwargs.get('endpoint_id', 'device 1')
            },
    ...
    def add_context_property_with_numbers(self, **kwargs):
        self.context_properties.append(self.create_context_property_with_numbers(**kwargs))
    ...
    def create_context_property_with_numbers(self, **kwargs):
        return {
        'namespace': kwargs.get('namespace', 'Alexa.EndpointHealth'),
        'name': kwargs.get('name', 'connectivity'),
        'value': kwargs.get('value', {'hue': 350,'saturation':0.7123,'brightness':0.6524}),
        'timeOfSample': get_utc_timestamp(),
        'uncertaintyInMilliseconds': kwargs.get('uncertainty_in_milliseconds', 0)
    }
